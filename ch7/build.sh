...
dd if=boot/mbr.bin of=/root/bochs/hd60M.img bs=512 count=1 conv=notrunc
dd if=boot/loader.bin of=/root/bochs/hd60M.img bs=512 count=4 seek=2 conv=notrunc
